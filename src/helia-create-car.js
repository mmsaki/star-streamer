...
const rootCID = await heliaFs.addDirectory();
console.log('Root CID: ', rootCID);
const file = await fs.createReadStream(input);
const fileCID = await heliaFs.addBytes(file);
console.log('File CID: ', fileCID);
const updatedCID = await heliaFs.cp(fileCID, rootCID, path.basename(input));
